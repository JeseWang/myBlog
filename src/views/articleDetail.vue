    ...
    <div class="article clearfix">
      ...
      >
        <div class="header">
          ...
          <div class="author">
            <div class="avatar">
              <img class="auth-logo" src="../assets/logo.jpg" alt="JesseWang">
            </div>
            <div class="info">
              <span class="name">
              ...
              <div class="meta">
                <span
                  class="publish-time"
                >{{articleDetail.create_time? formatTime(articleDetail.create_time): ''}}</span>
                <span class="wordage">字数 {{articleDetail.numbers}}</span>
                <span class="views-count">阅读 {{articleDetail.meta.views}}</span>
                <span class="comments-count">评论 {{articleDetail.meta.comments}}</span>
                <span class="likes-count">喜欢 {{articleDetail.meta.likes}}</span>
              </div>
            </div>
